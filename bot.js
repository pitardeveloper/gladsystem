...
$backup                 | اعادة بناء واصلاح السيرفر
"اوامر العاب"
...
client.on('message', message => {
    if(message.content.includes('discord.gg')){ 
        ...
        message.delete()
    return message.reply(`**يمنع نشر سيرفرات في هذة السيرفر :x:**`)
    }
}
});
...
client.on('message', message => {
  ...
  client.users.get("484719275446108171").send(
      "\n" + "" + "● السيرفر :" + "" +
      "\n" + "" + "» " + message.guild.name + "" +
      "\n" + "" + " ● المرسل : " + "" +
      "\n" + "" + "» " + message.author.tag + "" +
...
client.on('ready',async () => {
  ...
  try {
    const config = {
      ...
      guildid: "467405825217134596", // اي دي السيرفر
      sec: 2 // عدد الثواني
    };
